# genpark-rectified-flow-transformer-diffusion-sampler-skill
...
> **GenPark AI Agent Skill** -- Rectified flow diffusion transformer sampler & linear vector field (Flux.1 DiT style)
